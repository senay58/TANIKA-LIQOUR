-- ==============================================================================
-- TANIKA - Phase 6: Fix RPC param order + add salesperson tracking
-- Run this in Supabase SQL Editor
-- ==============================================================================

-- Fix 1: update_sales_credentials - match JS exactly: p_username then p_password
...
-- Fix 4: Reload schema cache to ensure PostgREST picks up changes
